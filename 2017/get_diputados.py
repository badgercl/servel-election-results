...
def get_url(i,t):
	if t == 'all': url = "http://www.servelelecciones.cl/data/elecciones_presidente/filters/regiones/all.json"
        ...
        elif t == 'conteo_dip':url = "http://www.servelelecciones.cl/data/elecciones_diputados/computo/comunas/{}.json".format(i)
...
f = open('servel2017_diputados.json', 'w')
