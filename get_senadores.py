...
def get_url(i,t):
	if t == 'all': url = "http://www.servelelecciones.cl/data/elecciones_presidente/filters/regiones/all.json"
        ...
        elif t == 'conteo_sen':url = "http://www.servelelecciones.cl/data/elecciones_senadores/computo/comunas/{}.json".format(i)
	return url
...
f = open('servel2017_sendadores.json', 'w')
